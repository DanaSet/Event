    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.execSQL("UPDATE kegiatan SET nomor = '" + editNomor.getText().toString() + "', event=  '" + editEvent.getText().toString() + "', tanggal= '" + editTanggal.getText().toString() + "', keterangan= '" + editKeterangan.getText().toString() + "', waktu_mulai= '" + editWaktuMulai.getText().toString() + "', waktu_akhir= '" + editWaktuAkhir.getText().toString() + "'");
